...
assert.equal(added.hotkey, 'CommandButton04');
assert.equal(added.hotkeyOmitted, false);
assert.equal(added.hotkeyFallback, true);
...
assert.match(out, /HotkeyUse val="CommandButton04"/);
